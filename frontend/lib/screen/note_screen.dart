...
//                   bool isCreated =
//                       await _apiNoteService.createNote(newNote.toJson());
//                   if (isCreated) {
...
//                     setState(() {
//                       _notes =
//                           _apiNoteService.getNotesByBoardId(widget.boardId);
//                     });
//                   } else {
...
//                   bool isUpdated =
//                       await _apiNoteService.updateNote(updatedNote);
//                   if (isUpdated) {
//                     ScaffoldMessenger.of(context).showSnackBar(SnackBar(
...
//                                     : Icons
//                                         .pin_drop, // Icon này cho trạng thái chưa ghim
//                                 color: note.isPinned
//                                     ? Colors.amber
//                                     : Colors
//                                         .grey, // Màu vàng cho ghim, màu xám cho không ghim
                  ...
                  child: ListTile(
                    ...
                    leading: IconButton(
                      icon: Icon(
                        ...
                        color: note.isPinned ? Colors.red : Colors.yellow,
                      ),
                      onPressed: () => _pinUnpinNote(note),
                    ),
                    trailing: PopupMenuButton<String>(
                      onSelected: (value) {
                        if (value == 'edit') {
